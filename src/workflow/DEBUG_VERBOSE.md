...
- 工作流配置读取：`src/workflow/engine.py`
- 最终响应拼装：`src/workflow/nodes/finalize_response/__init__.py`
- 健康检查透出：`src/api/main.py` 的 `GET /api/health`
- 启动脚本：`start_agent.ps1`
- 答案评测脚本：`src/workflow/eval/run_answer_eval.ps1`
...
在 `src/workflow/eval/run_answer_eval.ps1` 里设置：
